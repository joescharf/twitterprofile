...
func (uq *UserQuery) QueryAccounts() *StripeQuery {
	query := &StripeQuery{config: uq.config}
...
func (uq *UserQuery) WithAccounts(opts ...func(*StripeQuery)) *UserQuery {
	query := &StripeQuery{config: uq.config}
